class ArrowLauncher extends GroundObject
{
  PImage launcher;
  PImage arrowL;
  PImage arrowR;
  ...
  void setup ()
  {
    launcher = loadImage("ArrowLauncher.png");
  ...
  void draw()
  {
    if (visible() && mobStop == 0) {
      ...
      if (newBiome == 0 && keyPressed)
      {
        ...
        if (key == 'd' && rightStop == 0 && screenStopRight == 0) {
          arrowSpeed = 6;
          arrowDirection = 1;
        }
        else if ( key == 'a' && leftStop == 0 && screenStopLeft == 0) {
          arrowSpeed = 0;
          arrowDirection = - 1;
        }

        else if (key == 'r' && sprintRecover > 5 && arrowDirection >= 1 && screenStopRight == 0)
        {
          arrowSpeed= 8;
          arrowDirection = 1;
        } 

        else if (key == 'r' && sprintRecover > 5 && arrowDirection <= -1 && screenStopLeft == 0)
        {
          arrowSpeed = -2;
          arrowDirection =  -1;
        }    
